...
class AppealAdmin(admin.ModelAdmin):
    list_display = ['pk', 'name', 'skype', 'message', 'headset', 'sound_is_ok', 'date_of_group_start', 'date_of_create', 'worker', 'lead_time', 'speed_test', 'speed_test_note', 'camera', 'is_completed', 'is_deleted', 'type', 'is_spam', 'type_of_connection', 'time_to_complete']
